  ...
  if (data) {
    content = `<div class="inv-detail">
                ...
                <div class="inv-content">
                  ...
                  <p class="inv-price">Price: <strong>$${new Intl.NumberFormat("en-US").format(data.inv_price)}</strong></p>
                  <button>Buy</button>
                </div>
              </div>`
  } else {
    content = "<p>Sorry, no matching vehicle could be found.</p>"
  }
  return content
}
